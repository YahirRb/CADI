...
class Paquete(models.Model):
    idPaquete = models.AutoField(primary_key=True)  # Llave primaria de tipo entero con autoincremento
...
class PaqueteClases(models.Model):
    ...
    idPaquete = models.ForeignKey(Paquete, on_delete=models.CASCADE)  # Llave foránea a Paquete
    idClase = models.ForeignKey(Clase, on_delete=models.CASCADE)  # Llave foránea a Clase
    fechaInscripcion = models.DateField(null=True, blank=True)  # Campo opcional para la fecha de inscripción
